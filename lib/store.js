...
// grab the contents of the file named todos.json, parse it into a
// json object and return it from the function.
// the json file lives in current directory where our app is running
